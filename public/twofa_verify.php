...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $code = $_POST['code'];
    $user = $pdo->prepare("SELECT twofa_secret, profile_image FROM users WHERE id = ?");
    ...
    if ($tfa->verifyCode($secret, $code)) {
        ...
        $_SESSION['profile_image'] = $userData['profile_image']; // store image
        unset($_SESSION['2fa_user_id'], $_SESSION['2fa_username'], $_SESSION['2fa_role'], $_SESSION['2fa_profile_image']);
